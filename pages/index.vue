<template>
    <div class="relative min-h-[70vh] flex flex-col items-center justify-center text-gray-100 overflow-hidden">
        ...
        <div class="z-10 text-center">
            <!-- Responsive Image -->
            <img class="rounded-full mx-auto w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 mb-6 object-cover border-4 border-purple-600 transform transition-transform duration-500 hover:scale-110 animate__animated animate__fadeIn"
                src="../assets/images/WhatsApp Image 2024-09-24 at 15.20.37.jpeg" alt="Profile Picture"
...
@keyframes text-glow {
    ...
    0%,
    100% {
        text-shadow: 0 0 5px #4c51bf, 0 0 10px #4c51bf, 0 0 15px #4c51bf;
        /* Subtle glow */
    }
...
/* Ensure to install animate.css via npm or link in your project */
</style>